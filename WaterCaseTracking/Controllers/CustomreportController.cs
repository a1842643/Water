...
using static WaterCaseTracking.Models.ViewModels.Customreport.SearchListViewModel;
    ...
    public class CustomreportController : BaseController
    {
        ...
        public ActionResult searchInit()
        {
            ...
            try
            {
                ...
                //抓欄位下拉選單
                searchInitViewModel.ddlSYM = CustomreportService.getdllYM();
                //抓起YM下拉選單
                searchInitViewModel.ddlEYM = CustomreportService.getdllYM();
                //抓迄YM下拉選單
                searchInitViewModel.ddlFileColumns = CustomreportService.getdllColums();
                searchInitViewModel.ddlArea = CustomreportService.getddlArea();
        ...
        public ActionResult Export(ExportViewModel exportViewModel)
        {
            ...
            {
                //查詢修改資料
                dt = CustomreportService.getExportData(exportViewModel);

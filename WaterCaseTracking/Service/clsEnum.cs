...
namespace Common
{
    public class clsEnum
    {
        ...
        /// <summary>
        /// string_List(string_string_string)
        /// </summary>
        /// <returns></returns>
        public Dictionary<string, List<Tuple<string, string>>> getJobContent()
        {
            ...
            FuncAttributeT.Add(new Tuple<string, string>("ImportFiles", "轉檔"));
            JobContent.Add("T", FuncAttributeT);
            ...
            FuncAttributeR.Add(new Tuple<string, string>("06OperatedCardAllUnitResult", "全行營運概況表"));
            ...
            JobContent.Add("R", FuncAttributeR);

            List<Tuple<string, string>> FuncAttributeB= new List<Tuple<string, string>>();
            FuncAttributeT.Add(new Tuple<string, string>("ImportFiles", "資料移轉"));
            JobContent.Add("B", FuncAttributeR);
            return JobContent;
        }
    }
}
